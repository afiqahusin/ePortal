    	...
    	<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        	<div class="position-sticky">
            	<div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="#FinanceCollapse" aria-current="true" aria-controls="FinanceCollapse" data-bs-toggle="collapse" aria-expanded="true" class="list-group-item list-group-item-action py-2"><i class="bi bi-wallet2 me-3"></i><span>Phone Directory</span></a>
                    <ul class="collapse list-group list-group-flush ps-4" id="FinanceCollapse">
                      <li class="list-group-item py-1 "><a href="Phone_Add.php" class="list-group-item list-group-item-action py-2 " aria-current="true"><i class="fa-solid fa-heart-pulse"></i><span>Add Phone</span></a></li>
                      <li class="list-group-item py-1 "><a href="Phone_Edit.php" class="list-group-item list-group-item-action py-2 " aria-current="true"><i class="fa-solid fa-heart-pulse"></i><span>Update</span></a></li>
                    </ul>
                    <a href="OTSTAT_Add.php" class="list-group-item list-group-item-action py-2 " aria-current="true"><i class="fa-solid fa-heart-pulse"></i><span>OT Status</span></a>
