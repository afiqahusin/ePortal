...
<head>
    ...
    <meta charset="utf-8">
	<title>ePortal</title>
	<link rel="shortcut icon" type="images/png" href="logo 1"/>
							...
							<div class="container-fluid">
								...
								<ul style="font-color:red; font-weight: 600;font-size: 15px;text-transform: uppercase;"  class="navbar-nav me-auto mb-2 mb-lg-0">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										<li><a class="dropdown-item" href="doc/consultant_nov_latest">Monthly Roster </a></li>
		...
		<div class="container">
			<div class="row">
				 <table class="table fl-table">
					...
					<tr>
						<td>Muhamad Izzuan</td>
						<td>Finance Executive</td>
						<td>7950</td>
						<td>-</td>
					</tr>
					<tr>
						<td>che Masheta / Khairunnajat</td>
						<td>Senior Clerk</td>
						<td>7951</td>
						<td>-</td>
					</tr>
					<tr>
						<td>Sainatus Safiyah</td>
						<td>Finance Clerk</td>
						<td>7950</td>
						<td>-</td>
					</tr>
						<tr>
							<td>Mohammad Faruqi</td>
...
<div class="modal fade" id="marketing" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">MARKETING/PUBLIC RELATION</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		...
		<div class="container">
			<div class="row">
				 <table class="table fl-table">
					...
					<tr>
						<td>Nazatul Shima</td>
						<td>Deputy Manager Marketing</td>
						<td>7957</td>
						<td>-</td>
					</tr>
					 <tr>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="d-flex flex-row bd-highlight mb-3">
						...
						<div class="p-2 bd-highlight">
							<button style="height:70px" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#counter">
							<span style="font-size:14px">BILLING COUNTER</span>
							</button>
							</div>
						</div>
						</div>
				 ...
				 <table class="table fl-table">
					<thead>
					   <tr>
						...
						<tr>
							<td>Dr Wong / Dr Siti</td>
							<td>Visiting Consultant</td>
							<td>6869</td>
							<td>-</td>	
                            <td>7869(Jothi)</td>							
						</tr>
...
<div class="modal fade" id="rehab" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PHYSIOTHERAPHY</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
				 ...
				 <table class="table fl-table">
					<thead>
					   <tr>
						...
						<tr>
							<td>Counter (Inpatient)</td>
							<td>Physiotherapist</td>
							<td> 7027</td>
							<td>-</td>				  
						</tr>
						<tr>
							<td>Counter (Outpatient)</td>
							<td>Physiotherapist</td>
							<td> 7965</td>
							<td>-</td>				  
						</tr>
...
<div class="modal fade" id="counter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">BILLING COUNTER</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="d-flex flex-row bd-highlight mb-3">
						...
						<div class="p-2 bd-highlight">
							<button style="height:70px" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#control">
								<span style="font-size:14px">CONTROL ROOM</span>
							</button>
							</div>
						<div class="p-2 bd-highlight">
							<button style="height:70px" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#shop">
								<span style="font-size:14px">HEALTH SHOP / SALAM</span>
							</button>
							</div>
						<div class="p-2 bd-highlight">
							<button style="height:70px" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#total">
								<span style="font-size:14px">TOTAL MEAL & CAFE</span>
							</button>
							</div>								
						</div>
						</div>
...
<div class="modal fade" id="did" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Diagnostic Imaging</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
				 ...
				 <table class="table fl-table">
					<thead>
					   <tr>
						...
						<tbody>
						<tr>
							<td>Ikmal Mardiha / Thaneswary</td>
							<td>Admission</td>
							<td>7734</td>
							<td>-</td>
						</tr>
						<tr>
							<td>Sara Syakira / Afiqah</td>
							<td>Admission</td>
							<td>7724</td>
							<td>-</td>				  
						</tr>
				 ...
				 <table class="table fl-table">
					<thead>
					   <tr>
						...
						<tr>
							<td>Noraini/ Shahira</td>
							<td>Billing Clerk(Inpatient)</td>
							<td>7026</td>
							<td>-</td>				  
						</tr>
						<tr>
...
<div class="modal fade" id="total" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">TOTAL MEAL & CAFE</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
...
<div class="modal fade" id="control" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">CONTROL ROOM</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
...
<div class="modal fade" id="control" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">HEALTH SHOP / SALAM </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<div class="container">
