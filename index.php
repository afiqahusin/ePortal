  ...
  <div id="pageloader">   
   ...
   <!--Start Navigation-->
	...
	<!-- CAROUSEL 
          ...
          <!-- End Slider  -->
		  <!-- countdown-->
	<p style="text-align:center; margin-top:80px"> <img class = "center text allign"  src ="images/msqh.jpg"  width = "500" height = "150"/></p>
	<center><script src="https://cdn.logwork.com/widget/countdown.js"></script>
	<div style="font-size:20px; margin-top:70px"><b>
	MSQH ACCREDITATION SURVEY 7 NOV - 9 NOV '22 </b></div>
	<div>
	<a href="https://logwork.com/countdown-wn4s" class="countdown-timer" data-width="500" data-timezone="Asia/Kuala_Lumpur" data-date="2022-11-07 08:30"><b > <span style="font-size:500px">
	__________________________</span></b></a></div>
	</center>
